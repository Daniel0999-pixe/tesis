...
joblib.dump(label_encoder_materia, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\label\label_encoder_materiaM2.joblib')
joblib.dump(label_encoder_ciclo, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\label\label_encoder_cicloM2.joblib')
joblib.dump(label_encoder_curso, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\label\label_encoder_cursoM2.joblib')
# Definir características y variable objetivo
X = data[['MATERIA', 'CICLO', 'resultado_tic', 'resultado_dic', 'resultado_ped']]
...
test_set_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\conjunto_pruebaM2.xlsx'
...
model_path = r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\modelos'
...
for model_name, model in models.items():
    ...
    model_filename = f'{model_path}/{model_name.replace(" ", "_")}M2.joblib'
...
normal_results_excel_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\resultados_normales_MC_M2.xlsx'
...
excel_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\totales_matriz_confusion_resumen_M2.xlsx'
...
for model in confusion_totals_summary_df['Modelo']:
    ...
    plt.ylabel('Realidad')
    plt.savefig(f'C:\\xampp\\htdocs\\tesis2\\imagenes\\modelo2\\entrenamiento\\matriz_confusion_{model.replace(" ", "_")}ponM2.png', bbox_inches='tight')
    plt.close()
...
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo2\entrenamiento\curva_roc_M1.png', bbox_inches='tight')  # Guardar la imagen
plt.close()
...
roc_metrics_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\resultados_roc_train_M2.xlsx'
...
distances_output_file_path_manhattan_xlsx = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\distancias_knn_manhattan.xlsx'
...
metrics_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\resultados_metricas_modelosM2.csv'
...
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo2\entrenamiento\metricas_modelosM2.png')  
plt.close()