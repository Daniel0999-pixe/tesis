...
file_path_prueba = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\conjunto_pruebaM2.xlsx'
data_prueba = pd.read_excel(file_path_prueba)

# Cargar el DataFrame de resultados de predicciones
file_path_predicciones = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_predicciones_todos_modelosM2.xlsx'
...
output_file_path_comparacion = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_comparacionM2.xlsx'
...
plt.title('Porcentaje de Similitud entre Resultados Predichos y Reales Escenario 2')

# Agregar leyenda con los nombres de los algoritmos
plt.legend(similitudes.index, title="Algoritmos", loc="upper right")

# Guardar el gráfico como imagen
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo2\prueba\grafico_similitud_M2.png')
plt.show()