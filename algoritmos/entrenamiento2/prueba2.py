...
file_path_prueba = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\pruebaM2.xlsx'
data_prueba = pd.read_excel(file_path_prueba)

# Cargar los LabelEncoders utilizados para codificar las etiquetas
label_encoder_materia = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\label\label_encoder_materiaM2.joblib')
label_encoder_ciclo = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\label\label_encoder_cicloM2.joblib')
label_encoder_curso = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\label\label_encoder_cursoM2.joblib')
...
X_prueba = data_prueba[['MATERIA', 'CICLO', 'resultado_tic', 'resultado_dic', 'resultado_ped']]

# Cargar los modelos entrenados
model_knn = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\modelos\K-Nearest_NeighborsM2.joblib')
model_rf = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\modelos\Random_ForestM2.joblib')
model_dt = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento2\modelos\Decision_TreeM2.joblib')
...
metrics_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\resultados_metricas_modelosM2.csv'
...
output_file_path_predictions_all_models = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_predicciones_todos_modelosM2.xlsx'
...
data_prueba_best_model['CICLO'] = label_encoder_ciclo.inverse_transform(data_prueba_best_model['CICLO'])

# Guardar resultados del mejor modelo en un nuevo archivo Excel
output_file_path_best_model_predictions = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_prediccionesM2.xlsx'
...
for model_name in results.keys():
    ...
    output_file_path_model_predictions = f'C:\\xampp\\htdocs\\tesis2\\dataframe\\modelo2\\prueba\\resultados_predicciones_{model_name}M2.xlsx'
...
for model_name in results.keys():
    ...
    output_image_path_cursos = f'C:\\xampp\\htdocs\\tesis2\\imagenes\\modelo2\\prueba\\distribucion_cursos_recomendados_{model_name}M2.png'
