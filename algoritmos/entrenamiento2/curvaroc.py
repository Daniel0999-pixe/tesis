...
datos_reales = pd.read_excel(r"C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\conjunto_pruebaM2.xlsx")
...
archivos_predicciones = [
    r"C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_predicciones_K-Nearest NeighborsM2.xlsx",
    r"C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_predicciones_Random ForestM2.xlsx",
    r"C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_predicciones_Decision TreeM2.xlsx"
]
...
plt.title('Curvas ROC para Algoritmos (Resultados Reales vs Resultados Recomendación), Escenario 2')

plt.legend(loc='lower right')  
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo2\prueba\curva_roc_realvspredic_M2.png', bbox_inches='tight')
...
df_resultados_expandido.to_excel(r'C:\xampp\htdocs\tesis2\dataframe\modelo2\prueba\resultados_curvas_roc_M2.xlsx', index=False)

print("Los resultados se han guardado en resultados_curvas_roc_M2.xlsx")