...
datos_reales = pd.read_excel(r"C:\xampp\htdocs\tesis2\dataframe\modelo4\entrenamiento\conjunto_pruebaM4.xlsx")
...
archivos_predicciones = [
    r"C:\xampp\htdocs\tesis2\dataframe\modelo4\prueba\resultados_predicciones_K-Nearest NeighborsM4.xlsx",
    r"C:\xampp\htdocs\tesis2\dataframe\modelo4\prueba\resultados_predicciones_Random ForestM4.xlsx",
    r"C:\xampp\htdocs\tesis2\dataframe\modelo4\prueba\resultados_predicciones_Decision TreeM4.xlsx"
]
...
plt.title('Curvas ROC para Algoritmos (Resultados Reales vs Resultados Recomendación), Escenario 4')

plt.legend(loc='lower right')  
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo4\prueba\curva_roc_realvspredic_M4.png', bbox_inches='tight')
...
df_resultados_expandido.to_excel(r'C:\xampp\htdocs\tesis2\dataframe\modelo4\prueba\resultados_curvas_roc_M4.xlsx', index=False)

print("Los resultados se han guardado en resultados_curvas_roc_M4.xlsx")