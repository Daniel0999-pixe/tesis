...
# Codificar variables categóricas con LabelEncoders separados
label_encoder_materia = LabelEncoder()
data['MATERIA'] = label_encoder_materia.fit_transform(data['MATERIA'])
label_encoder_ciclo = LabelEncoder()
data['CICLO'] = label_encoder_ciclo.fit_transform(data['CICLO']) 
...
# Guardar los LabelEncoders utilizados para codificar las etiquetas
joblib.dump(label_encoder_materia, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento4\label\label_encoder_materiaM4.joblib')
joblib.dump(label_encoder_ciclo, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento4\label\label_encoder_cicloM4.joblib')
joblib.dump(label_encoder_curso, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento4\label\label_encoder_cursoM4.joblib')
joblib.dump(label_encoder_carrera, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento4\label\label_encoder_carreraM4.joblib')
# Definir características y variable objetivo
X = data[['MATERIA', 'CICLO', 'CARRERA','agrtic', 'agrdic', 'agrped' ]]
...
test_set['MATERIA'] = label_encoder_materia.inverse_transform(test_set['MATERIA'])
test_set['AREA'] = data.loc[X_test.index, 'AREA'].values
test_set['CARRERA'] = label_encoder_carrera.inverse_transform(test_set['CARRERA'])
test_set['CICLO'] = label_encoder_ciclo.inverse_transform(test_set['CICLO'])
test_set['resultado_tic'] = data.loc[X_test.index, 'resultado_tic'].values
test_set['resultado_dic'] = data.loc[X_test.index, 'resultado_dic'].values
test_set['resultado_ped'] = data.loc[X_test.index, 'resultado_ped'].values
...
column_order = [
    ...
    'resultado_tic', 'agrtic',  'resultado_dic', 'agrdic', 
    'resultado_ped', 'agrped', 'total_proceso',
...
test_set_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo4\entrenamiento\conjunto_pruebaM4.xlsx'
...
# Contador de reajustes por modelo.
reajuste_count = {model_name: 0 for model_name in models.keys()}
...
model_path = r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento4\modelos'
...
for model_name, model in models.items():
    ...
    model_filename = f'{model_path}/{model_name.replace(" ", "_")}M4.joblib'
...
normal_results_excel_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo4\entrenamiento\resultados_normales_MC_M4.xlsx'
...
excel_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo4\entrenamiento\totales_matriz_confusion_resumen_M4.xlsx'
...
for model in confusion_totals_summary_df['Modelo']:
    ...
    plt.savefig(f'C:\\xampp\\htdocs\\tesis2\\imagenes\\modelo4\\entrenamiento\\matriz_confusion_{model.replace(" ", "_")}ponM4.png', bbox_inches='tight')
    plt.close()
...
plt.title('Curvas ROC Promediadas por Modelo')
plt.legend(loc='lower right')    
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo4\entrenamiento\curva_roc_M4.png', bbox_inches='tight')  # Guardar la imagen
plt.close()
...
roc_metrics_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo4\entrenamiento\resultados_roc_M4.xlsx'
...
distances_output_file_path_manhattan_xlsx = r'C:\xampp\htdocs\tesis2\dataframe\modelo4\entrenamiento\distancias_knn_manhattan.xlsx'
...
for model_name, model in models.items():
    joblib.dump(model, f'C:\\xampp\\htdocs\\tesis2\\algoritmos\\entrenamiento4\\modelos\\{model_name.replace(" ", "_")}M4.joblib')
...
metrics_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo4\entrenamiento\resultados_metricas_modelosM4.csv'
...
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo4\entrenamiento\metricas_modelosM4.png')  
plt.close()