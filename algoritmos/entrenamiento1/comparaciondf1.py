...
file_path_prueba = r'C:\xampp\htdocs\tesis2\dataframe\modelo1\entrenamiento\conjunto_pruebaM1.xlsx'
data_prueba = pd.read_excel(file_path_prueba)

# Cargar el DataFrame de resultados de predicciones
file_path_predicciones = r'C:\xampp\htdocs\tesis2\dataframe\modelo1\prueba\resultados_predicciones_todos_modelosM1.xlsx'
...
output_file_path_comparacion = r'C:\xampp\htdocs\tesis2\dataframe\modelo1\prueba\resultados_comparacionM1.xlsx'
...
plt.title('Porcentaje de Similitud entre Resultados Predichos y Reales Escenario 1')

# Agregar leyenda con los nombres de los algoritmos
plt.legend(similitudes.index, title="Algoritmos", loc="upper right")

# Guardar el gráfico como imagen
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo1\prueba\grafico_similitud_M1.png')
plt.show()