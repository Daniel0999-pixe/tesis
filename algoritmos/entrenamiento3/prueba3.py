...
file_path_prueba = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\prueba\pruebaM3.xlsx'
data_prueba = pd.read_excel(file_path_prueba)

# Cargar los LabelEncoders utilizados para codificar las etiquetas
label_encoder_curso = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento3\label\label_encoder_cursoM3.joblib')

# Definir características para la predicción
X_prueba = data_prueba[['agrtic', 'agrdic', 'agrped',]]

# Cargar los modelos entrenados
model_knn = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento3\modelos\K-Nearest_NeighborsM3.joblib')
model_rf = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento3\modelos\Random_ForestM3.joblib')
model_dt = joblib.load(r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento3\modelos\Decision_TreeM3.joblib')
...
metrics_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\resultados_metricas_modelosM3.csv'
...
output_file_path_predictions_all_models = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\prueba\resultados_predicciones_todos_modelosM3.xlsx'
...
output_file_path_best_model_predictions = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\prueba\resultados_prediccionesM3.xlsx'
...
for model_name in results.keys():
    ...
    output_file_path_model_predictions = f'C:\\xampp\\htdocs\\tesis2\\dataframe\\modelo3\\prueba\\resultados_predicciones_{model_name}M3.xlsx'
...
for model_name in results.keys():
    ...
    output_image_path_cursos = f'C:\\xampp\\htdocs\\tesis2\\imagenes\\modelo3\\prueba\\distribucion_cursos_recomendados_{model_name}M3.png'
