...
datos_reales = pd.read_excel(r"C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\conjunto_pruebaM3.xlsx")
...
archivos_predicciones = [
    r"C:\xampp\htdocs\tesis2\dataframe\modelo3\prueba\resultados_predicciones_K-Nearest NeighborsM3.xlsx",
    r"C:\xampp\htdocs\tesis2\dataframe\modelo3\prueba\resultados_predicciones_Random ForestM3.xlsx",
    r"C:\xampp\htdocs\tesis2\dataframe\modelo3\prueba\resultados_predicciones_Decision TreeM3.xlsx"
]
...
plt.title('Curvas ROC para Algoritmos (Resultados Reales vs Resultados Recomendación), Escenario 3')

plt.legend(loc='lower right')  
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo3\prueba\curva_roc_realvspredic_M3.png', bbox_inches='tight')
...
df_resultados_expandido.to_excel(r'C:\xampp\htdocs\tesis2\dataframe\modelo3\prueba\resultados_curvas_roc_M3.xlsx', index=False)

print("Los resultados se han guardado en resultados_curvas_roc_M3.xlsx")
