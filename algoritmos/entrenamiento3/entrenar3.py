...
joblib.dump(label_encoder_curso, r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento3\label\label_encoder_cursoM3.joblib')
# Definir características y variable objetivo
X = data[['agrtic', 'agrdic', 'agrped' ]]
...
test_set_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\conjunto_pruebaM3.xlsx'
...
model_path = r'C:\xampp\htdocs\tesis2\algoritmos\entrenamiento3\modelos'
...
for model_name, model in models.items():
    ...
    model_filename = f'{model_path}/{model_name.replace(" ", "_")}M3.joblib'
...
normal_results_excel_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\resultados_normales_MC_M3.xlsx'
...
excel_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\totales_matriz_confusion_resumen_M3.xlsx'
...
for model in confusion_totals_summary_df['Modelo']:
    ...
    plt.savefig(f'C:\\xampp\\htdocs\\tesis2\\imagenes\\modelo3\\entrenamiento\\matriz_confusion_{model.replace(" ", "_")}M3.png', bbox_inches='tight')
    plt.close()
...
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo3\entrenamiento\curva_roc_M3.png', bbox_inches='tight')  # Guardar la imagen
plt.close()
...
roc_metrics_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\resultados_roc_M3.xlsx'
...
# Guardar los resultados en un archivo XLSX con formato en filas detalladas
roc_metrics_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo2\entrenamiento\resultados_roc_train_M3.xlsx'
with pd.ExcelWriter(roc_metrics_output_file_path, engine='openpyxl') as writer:
    roc_metrics_df.to_excel(writer, sheet_name='Resultados ROC', index=False)
...
distances_output_file_path_manhattan_xlsx = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\distancias_knn_manhattan.xlsx'
...
for model_name, model in models.items():
    joblib.dump(model, f'C:\\xampp\\htdocs\\tesis2\\algoritmos\\entrenamiento3\\modelos\\{model_name.replace(" ", "_")}M3.joblib')
...
metrics_output_file_path = r'C:\xampp\htdocs\tesis2\dataframe\modelo3\entrenamiento\resultados_metricas_modelosM3.csv'
...
plt.savefig(r'C:\xampp\htdocs\tesis2\imagenes\modelo3\entrenamiento\metricas_modelosM3.png')  
plt.close()